...
import { Main, About, TestManage, ColumnManage, UserManage, AddPkg, AddCol, ee, ModifyPkg, SmsTest, TestStartPage, TestResult, CoupleManage,ColumnScreen, VideoManage, AddVideo, RevisePkg } from 'Pages';
